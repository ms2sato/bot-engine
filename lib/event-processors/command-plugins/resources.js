  ...
  this.eventHandlers.push({
    ...
    handler: function handler(bot, message) {
      ...
      return entities.getProp(message[object], prop).done(function (value) {
        bot.reply(message, _this3.engine.i18n.t('be.showprop.message', { label: type.toLabel(value) }));
      });
    }
  });
};
...
var HashPropertyType = function (_CollectionPropertyTy2) {
  ...
  function HashPropertyType() {
    ...
    var _this5 = _possibleConstructorReturn(this, (HashPropertyType.__proto__ || Object.getPrototypeOf(HashPropertyType)).call(this));

    _this5.keyLabel = keyLabel;
    _this5.valueLabel = valueLabel;
    return _this5;
  }
    ...
    handler: function handler(bot, message) {
      ...
      return promises.toPromise(type.value(message, bot)).then(function (value) {
        if (_.isUndefined(value)) {
          return bot.reply(message, _this6.engine.i18n.t('be.addprop.message.fail'));
        }
        ...
        return entities.safeGet(message[object], defaults).then(function (entity) {
          ...
          bot.reply(message, _this6.engine.i18n.t('be.addprop.message.success', {
            prop: prop,
